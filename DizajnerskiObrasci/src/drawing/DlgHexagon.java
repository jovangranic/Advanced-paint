...
public class DlgHexagon extends JDialog {
	...
	public DlgHexagon() {
		...
		setTitle("Add or modify an existing hexagon");
		setResizable(false);
		setModal(true);
		...
		}
		{
			...
			textFieldX.setFont(new Font("Tahoma", Font.PLAIN, 15));
		...
		}
		{
			...
			textFieldY.setFont(new Font("Tahoma", Font.PLAIN, 15));
		...
		{
			JLabel lblRadius = new JLabel("Hexagon radius:");
		...
		{
			JLabel lblHexagonAdapter = new JLabel("HEXAGON");
			lblHexagonAdapter.setBackground(Color.LIGHT_GRAY);
			lblHexagonAdapter.setHorizontalAlignment(SwingConstants.CENTER);
			lblHexagonAdapter.setFont(new Font("Tahoma", Font.PLAIN, 22));
			getContentPane().add(lblHexagonAdapter, BorderLayout.NORTH);
		}
		{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						try {
							...
							hexagon = new HexagonAdapter(x, y, radius, edgeColor, fillColor);
							dispose();
	...
	public void setHexagon(HexagonAdapter c) {
		setPoint(new Point(c.getX(), c.getY()));
		setColors(c.getColor(), c.getFillColor());
		textFieldRadius.setText("" + c.getR());
	}
