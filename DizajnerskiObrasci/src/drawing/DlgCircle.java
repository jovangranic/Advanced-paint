...
public class DlgCircle extends JDialog {
	...
	public DlgCircle() {
		...
		contentPanel.setBackground(new Color(153, 255, 102));
		...
		}
		{
			...
			btnInnerColor.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					innerColor = JColorChooser.showDialog(null, "Choose iner color", innerColor);
					if (innerColor == null) {
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						try {
							...
							circle = new Circle(new Point(x, y), radius, edgeColor, innerColor);
							dispose();
	...
	public void setCircle(Circle circle) {
		setPoint(circle.getCenter());
		setColors(circle.getColor(), circle.getInnerColor());
